...
TAGE_PREDICTOR::TAGE_PREDICTOR(void)
{
...
bool   TAGE_PREDICTOR::GetPrediction(UINT32 PC){
...
void  TAGE_PREDICTOR::UpdatePredictor(UINT32 PC, bool resolveDir, bool predDir, UINT32 branchTarget){
...
void    TAGE_PREDICTOR::TrackOtherInst(UINT32 PC, OpType opType, UINT32 branchTarget){
